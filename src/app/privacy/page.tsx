...
const sections: PrivacySection[] = [
  {
    ...
    body:
      'We gather details you provide directly (such as identity documents, application history, and contact information) as well as activity from your MapleLeed workspace. We may append publicly available data to better match you with housing, travel, or study opportunities.',
    bullets: [
  ...
  },
  {
    ...
    body:
      'Your information enables us to advise on visa strategy, prepare documentation, coordinate bookings, and communicate updates. We use anonymised insights to improve MapleLeed services, never to sell your personal data.',
    bullets: [
  ...
  },
  {
    ...
    body:
      'You can request access, corrections, or deletion of your records by emailing privacy@mapleleed.com. We retain core immigration and financial records for the period mandated by regulators and professional associations.',
  },
  {
    title: '5. Security',
    body:
      'MapleLeed uses encryption in transit and at rest, restricted access to files, multi-factor authentication, and continuous monitoring. We conduct regular audits of permissions and vendor practices to ensure your information stays protected.',
  },
  {
  ...
  },
  {
    title: '7. Contact',
    body:
      'Email privacy@mapleleed.com or write to MapleLeed Privacy Office, 1250 Bay Street, Toronto, ON, Canada. We respond to verified privacy requests within 30 days.',
  },
];
        ...
        <section className="relative isolate overflow-hidden py-24 text-white sm:py-32">
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-3xl space-y-6">
              ...
              <h1 className="text-balance text-4xl font-headline font-bold sm:text-5xl">MapleLeed Privacy Policy</h1>
          ...
          <div className="container mx-auto grid gap-10 px-6 lg:grid-cols-[0.65fr_1fr] lg:items-start">
            <div className="space-y-6 rounded-3xl border border-border bg-card p-6 shadow-lg">
              ...
              <div className="space-y-4 text-sm text-muted-foreground">
                ...
                <p>
                  Data requests: <a href="mailto:privacy@mapleleed.com" className="text-primary underline">privacy@mapleleed.com</a>
                </p>
              </div>
            </div>
